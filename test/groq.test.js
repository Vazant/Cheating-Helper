...
assert.strictEqual((geminiSource.match(/sendToGroq\(/g) || []).length, 2);
assert.ok(geminiSource.includes("currentGroqSession?.provider === 'omniroute' ? sendToOmniRoute(text) : sendToGroq(text)"));
